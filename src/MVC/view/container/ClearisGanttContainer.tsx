    ...
    render(): ReactNode {
        return (
            <div className="GanttLayout mx-groupbox w-100 h-100">
                ...
                ></ChartHeader>
                <ChartContent timeline={this.props.GanttController.getTimeline()} ref={this.props.GanttController.chartContentRef()} nodes={this.props.GanttController.getNodes()}></ChartContent>
            </div>
        );
    }
}
