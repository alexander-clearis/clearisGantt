...
import {TaskConnectionBase} from "./TaskConnectionBase";
...
export interface iTaskController {
    ...
    getConnections(): TaskConnectionBase[]
}

export class mockTaskController implements iTaskController {
    private tasks: iTask [] = [
        new mockTask("TAAK UNO", new Date(2019, 3, 1), new Date(2019, 4, 1)),
    ...
    private connections: TaskConnectionBase[] = [new TaskConnectionBase(this.tasks[0], this.tasks[2])]
